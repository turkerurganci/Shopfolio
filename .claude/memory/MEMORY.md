...
- **Sırada:** **Blok 8** — yönetim, bildirim, kötüye kullanım ve yasal uyum; on altı konu, tahmin iki oturum. **İlk oturum, ilk konu açılmadan önce A-06…A-10'u kapatır:** üçü ⚠ — **A-06** fiziksel teslimin kaydı (cayma penceresi ve ayıp süresi bu tarihten başlar; hizmette pencerenin başlangıcı), **A-07** iptalde geri ödemenin tetikleyicisi ve süresi + kısmi caymada kargo bedeli, **A-08** iadede malın geri gönderilme biçimi; ikisi öneriyle — **A-09** durum makinesinin dört köşesi, **A-10** ürün yayın durumunda iki geçiş. **Blok 8'in kapanışında** `checklists/document-stage.md` §3'ün yeni K-29 taraması ilk kez koşar.
