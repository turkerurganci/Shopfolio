...
- **Taslaklar:** `01` **v0.4** (§1–§5) · `02` **v0.7** (§1–§3, §5–§7; §4, §8–§10 ve §12 Blok 8'de, §11 ve §13 Blok 9'da) · `10` henüz yazılmadı. Blok 8 ve 9'un bu taslaklara dokunan kararları K-29'un `(taslak güncellenecek)` işaretini taşır.
- **`02 §1` Blok 8'den önce kapanmaz** — Blok 8'in işlem izi ve yönetim terimleri bekleniyor.
- **Sırada:** **Blok 8** — yönetim, bildirim, kötüye kullanım ve yasal uyum; on altı konu, tahmin iki oturum. **İlk oturum, ilk konu açılmadan önce A-06…A-10'u kapatır:** üçü ⚠ — **A-06** fiziksel teslimin kaydı (cayma penceresi ve ayıp süresi bu tarihten başlar; hizmette pencerenin başlangıcı), **A-07** iptalde geri ödemenin tetikleyicisi ve süresi + kısmi caymada kargo bedeli, **A-08** iadede malın geri gönderilme biçimi; ikisi öneriyle — **A-09** durum makinesinin dört köşesi, **A-10** ürün yayın durumunda iki geçiş. **Bekleyen proje sahibi kararı:** §6.2 sütununun düzeltilmesi (tracker §6.1 — Blok 1–3 etki birleşimine; Blok 8 `02 §1–§10, §12`'ye; Blok 9 `02 §3, §10, §11, §13`'e).
