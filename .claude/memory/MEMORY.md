...
- **Son tamamlanan:** **Blok 7 ✓ — tek oturum, elli bir karar (K-237…K-287), 2026-09-19.** Tahmin bir oturumdu, tuttu. Omurga: **beş hazır içerik tipi + genel sayfa** — Hakkımızda · Hizmet tanıtımı · Referans iş · SSS · Şube (K-237, K-238); ayrı galeri tipi yok · hizmet tanıtımı fiyatsızdır, "Bize ulaşın" iletişim formuna gider (K-240) · içerik katalogdan ürün bağlar (K-245) · "ana sayfada göster" işareti ve elle sıra (K-246, K-247) · **menü düzenleyici yok, menü adları değiştirilebilir** (K-248) · gömülü harita, video, sosyal akış ve serbest kod yok (K-243, K-249, K-254, K-263) · **marka: logo, marka adı, site simgesi, tek marka rengi**; yazı tipi ve düzen üründe, logo zorunlu değil (K-258, K-259) · tek metin biçimi seti + ara başlık (K-267) · **blog yok, duyuru şeridi var** (K-268, K-269) · site boş kurulur (K-271) · içerikte Taslak/Yayında — arşiv ve sürüm geçmişi yok (K-273, K-276) · **ürün adresi kategoriden bağımsız, adres kalıcı, yönlendirme sistemi yok** (K-279, K-280) · arama motoru bilgileri otomatik (K-282) · paylaş düğmesi (K-287). Ayrıntı: tracker §6.2.
- **Önceki blok:** Blok 6 ✓ (2026-09-18) — yetmiş sekiz karar (K-159…K-236): iki ödeme yöntemi, iki eksenli durum makinesi, kalem düzeyinde iptal ve iade, ürün fatura kesmez, satışı geçici kapatma anahtarı. Ayrıntı: tracker §6.2.
...
- **Taslak güncellemeleri (K-29) yapıldı:** `02` → **v0.6** — sözlük 60 → **75 terim** (kurumsal içerik ve marka kimliği grupları; on beşinin de karşılığı kayıtta, A-05 **33'te kaldı**), yedi tanım düzeltildi (Ana kategori · Yayın durumu · Taslak · Yayında · Arşiv · Hizmet · Firma). `01` değişmedi (**v0.4**).
- **`02 §1` Blok 8'den önce kapanmaz** — Blok 8'in işlem izi ve yönetim terimleri bekleniyor.
- **Sırada:** **`02 §2, §3, §5, §6, §7` taslak yazım oturumu** — beş bölümün kapısı açık (K-28: §2, §6, §7 Blok 6'nın, §3 ve §5 Blok 7'nin kapanışıyla). K-30 gereği **ayrı chat**; girdi karar kaydı §2/§4, `02` şablonu ve üst doküman `01` — workshop sohbet geçmişi değil. `02`'deki bölüm kapısı notlarının besleyen blok listeleri §6.2 sütunuyla hizalı değil; **sütun esastır** (K-28). Ardından **Blok 8** — yönetim, bildirim, kötüye kullanım ve yasal uyum; on altı konu, tahmin iki oturum. Sıra 2026-09-19'da önerildi, proje sahibi itiraz etmedi.
...
- **Açık kararlar:** **A-02, A-03, A-04** — `01` yazım oturumunun bulduğu boşluklar (A-03'ün kapsamı dört satır, K-100). **A-05** — sözlükte **33 türetilmiş** İngilizce karşılık (75 terimin 42'si kayıtta); vadesi `02`'nin son yazım oturumu, `03`/`04`'ten önce. Dördü de **detay**. Ayrıntı: tracker §4.
- **Gate durumu:** Implementation başlamadı, faz yok. Doküman: **01 ⏳ (v0.4)** · **02 ⏳ (v0.6)** · 10 ⏳ · 03–09, 11–12 ⬚. Blok planı: 0–7 ✓ · 8–9 ⬚. Plandaki 111 konunun **77'si** kapandı; kalan 34 konu (Blok 8: 16 · Blok 9: 18).
