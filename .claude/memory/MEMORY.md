...
- **Son yazım oturumu:** **`02 §1` taslağı yazıldı — 2026-09-15**, K-28'in ikinci uygulaması, K-30 gereği ayrı oturum (girdi: karar kaydı §2/§4, `02` şablonu, 00 §C.6 ürün bağlamı katmanı, üst doküman `01`; workshop geçmişi kullanılmadı). Sözlükte **22 terim** (K-17'nin üç sütunu), üç aktör + üç "aktör olmayan"; §2–§13'ün her birine **adıyla yazım kapısı** notu düştü. `02` → v0.2. **Oturumun bulguları ve akıbetleri:** (1) sözlükteki İngilizce karşılıkların **11'i kayıtta yok**, taslakta türetilip **†** ile işaretlendi → **A-05**, açık; (2) §6.2'nin "Hedef doküman" sütunu `02 §1`'i yalnız Blok 1 ve Blok 3'e bağlıyordu → **düzeltildi (PR #18)**, `02 §1` **Blok 4–8'e** eklendi; kapsam onay sırasında ikiye katlandı — ilk tespit Blok 4 ve 6'ydı, tarama Blok 5, 7, 8'i de gösterdi; (3) **K-88**'in etki sütunu → **düzeltildi**, `02 §1, §3` oldu; (4) **kapalı Blok 3'ün üç kavramı sözlükte yoktu** — İndirim (39 kez), Kupon (41), Referans fiyat (6); kararları `02 §3`/`§5`'e yönlendirilmiş, `§1`'e yönlendirilmemişti → **eklendi (PR #19)**, sözlük 22 → **25 terim**; K-63 ve K-70'in etki sütunları da düzeltildi. **Sepet** (34) ve **Sipariş kalemi** (10) bilinçli bekletiliyor — `B5-01`/`B5-03` ve `B6-04`'e bağlı, bugün yazılamaz. Hepsi tracker §6.1'de.
- **Üç PR'lık zincir, hepsi 2026-09-15:** #17 taslak · #18 besleyen blok kümesi düzeltmesi · #19 İndirim/Kupon/Referans fiyat. **Desen:** yazım oturumu kaydın **haritasında** iki ayrı hata buldu — biri gelecek blokların bağlanmaması, biri kapalı bloğun terimlerinin yanlış bölüme yönlendirilmesi. İkisinin de kök sebebi aynı: **etki sütunu bir kararın hangi bölüme dokunduğunu tek başına taşıyor, sözlük gibi bloklar arası bölümler bu türetimde görünmüyor.** K-30'un "yazım, kaydın yeterlilik testidir" iddiasının en güçlü doğrulaması.
- **`02 §1` artık Blok 8'den önce kapanmaz.** Sözlük bloklar arası bir bölümdür; blok başına ne eklendiğinin denetimi `INSTRUCTIONS §2`'nin **konu kapanışında tamlık taraması** kuralına düşer — kural PR #16'da terfi etmişti, ilk gerçek işi bu.
