...
> **Taslak durumu (K-28):** §1, §2, §3, §5, §6 ve §7 **taslak** olarak yazılmıştır. §1 2026-09-15'te yazıldı; o gün §6.2'nin "Hedef doküman" sütunu bu bölümü Blok 1 ve Blok 3'e bağlıyordu ve ikisi de kapalıydı. §2, §3, §5, §6 ve §7 2026-09-19'da yazıldı; besleyen bloklarının tamamı kapalıydı — hem §6.2 sütununa hem kararların etki sütunlarına göre (§2: 1, 6, 7 · §3: 1–7 · §5: 1, 3–7 · §6: 1, 3, 5, 6 · §7: 1, 6). §4 ve §8–§13 henüz yazılmamıştır — her bölümün yazım kapısı kendi başlığının altındadır; kapılardaki besleyen blok listeleri 2026-09-19'da §6.2 sütunu ile etki sütunlarının birleşimine hizalandı. Kalite döngüsü (audit → deep review → cross-review → etki yansıtma → checkpoint) bu dokümanda **tüm bloklar kapandıktan sonra** ve **bir kez** koşar; sıra `01` → `02` → `10`'dur (00 §C.5).
...
> **Yazım kapısı (K-28):** **Blok 8 kapandığında** yazılır — besleyen bloklar: 1 ✓, 2 ✓, 3 ✓, 4 ✓, 6 ✓, 7 ✓, 8. Girdi: karar kaydında etki sütunu `02 §10` taşıyan satırlar ve `B8-02`, `B8-14`'e bırakılan devirler. *Liste 2026-09-19'da hizalandı; önceki not "7 ve 8" diyordu.*
